    ...
    extends Service
{
  ...
  /*  public CalculatorImpl(URL wsdlLocation, QName serviceName, WebServiceFeature... features) {
    ...
    public ProductService getCalculatorImplPort() {
        return super.getPort(new QName("vishar.com", "CalculatorImplPort"), ProductService.class);
    }
     ...
     */
    @WebEndpoint(name = "CalculatorImplPort")
    public ProductService getCalculatorImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("vishar.com", "CalculatorImplPort"), ProductService.class, features);
    }
