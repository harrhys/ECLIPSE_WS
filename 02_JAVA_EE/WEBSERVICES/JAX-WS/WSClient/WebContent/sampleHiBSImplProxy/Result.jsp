...
<jsp:useBean id="sampleHiBSImplProxyid" scope="session" class="com.farbig.web.services.HiBSImplProxy" />
<%
...
%>
        ...
        case 10:
                gotMethod = true;
                com.farbig.web.services.HiBSImpl getHiBSImpl10mtemp = sampleHiBSImplProxyid.getHiBSImpl();
