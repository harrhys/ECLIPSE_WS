...
public class CMTHibernateHandler implements DataHandler{
	...
	public CMTHibernateHandler() {
		
		System.out.println("INSIDE CMT Handler");
		java.util.logging.Logger.getLogger("org.hibernate").setLevel(Level.OFF);
		java.util.logging.Logger.getLogger("org.slf4j").setLevel(Level.OFF);
		config = new Configuration().configure("hibernate.cmt.cfg.xml");
		config.setInterceptor(new MyInterceptor());
		System.out.println("Starting CMT Handler");
