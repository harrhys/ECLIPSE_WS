...
public class FullMenuItem {
	...
	*/
	...
	private List<FullMenuItem> menuItem;

	
	public FullMenuItem() {
	}
	
	public FullMenuItem(int id,  String menuCode, List menuItem) {
		super();
		this.id = id;
...
*/
	...
	@XmlElement  
	public List<FullMenuItem> getMenuItem() {
		return menuItem;
	}

	public void setMenuItem(List<FullMenuItem> menuItems) {
