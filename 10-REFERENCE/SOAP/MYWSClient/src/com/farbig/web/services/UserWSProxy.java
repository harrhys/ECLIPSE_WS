...
public class UserWSProxy implements com.farbig.web.services.UserWS {
  private String _endpoint = null;
  private com.farbig.web.services.UserWS userWS = null;
  ...
  private void _initUserWSProxy() {
    try {
      userWS = (new com.farbig.web.services.UserWSServiceLocator()).getUserWS();
      if (userWS != null) {
        if (_endpoint != null)
  ...
  public com.farbig.web.services.UserWS getUserWS() {
    if (userWS == null)
      _initUserWSProxy();
    return userWS;
  }
