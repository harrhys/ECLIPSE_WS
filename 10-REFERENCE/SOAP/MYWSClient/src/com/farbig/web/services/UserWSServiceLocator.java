...
public class UserWSServiceLocator extends org.apache.axis.client.Service implements com.farbig.web.services.UserWSService {
    ...
    private java.lang.String UserWS_address = "http://localhost:7001/MYWS/services/UserWS";
    ...
    public com.farbig.web.services.UserWS getUserWS(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.farbig.web.services.UserWSSoapBindingStub _stub = new com.farbig.web.services.UserWSSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.farbig.web.services.UserWS.class.isAssignableFrom(serviceEndpointInterface)) {
                com.farbig.web.services.UserWSSoapBindingStub _stub = new com.farbig.web.services.UserWSSoapBindingStub(new java.net.URL(UserWS_address), this);
                _stub.setPortName(getUserWSWSDDServiceName());
                return _stub;
            }
        }
