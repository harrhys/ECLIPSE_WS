...
<jsp:useBean id="sampleUserWSProxyid" scope="session" class="com.farbig.web.services.UserWSProxy" />
<%
...
case 10:
        gotMethod = true;
        com.farbig.web.services.UserWS getUserWS10mtemp = sampleUserWSProxyid.getUserWS();
