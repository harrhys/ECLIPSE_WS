...
//For more info see:
//http://download.oracle.com/docs/cd/E13222_01/wls/docs92/ejb/EJBGen_reference.html#wp1096088
@Session(
	ejbName = "###EJB_NAME###",
...
//For more info see:
//http://download.oracle.com/docs/cd/E13222_01/wls/docs92/ejb/EJBGen_reference.html#wp1069615
@FileGeneration(
	localHome = Constants.Bool.FALSE,
	localClass = Constants.Bool.FALSE,
	remoteHome = Constants.Bool.TRUE,
	remoteHomeName = "###EJB_NAME###Home",
	remoteClass = Constants.Bool.TRUE,
	remoteClassName = "###EJB_NAME###Interface")

//For more info see:
//http://download.oracle.com/docs/cd/E13222_01/wls/docs92/ejb/EJBGen_reference.html#wp1069795
@JarSettings(
	ejbClientJar = "###EJB_CLIENT_J2SE_JAR_FILE_NAME###")

//For more info see:
//http://download.oracle.com/docs/cd/E13222_01/wls/docs92/ejb/EJBGen_reference.html#wp1069845
@JndiName(
	remote = "com.weblogic.sample.ejbapp.###EJB_NAME###Home")

public class FubarBMTEJB extends FubarEJBBaseClass
{
	public final static String VERSION = "#.#";
	public final static String PACKAGE_AND_CLASS = "com.weblogic.sample.ejbapp.###EJB_NAME###";
	...
	// For more info see:
	// http://download.oracle.com/docs/cd/E13222_01/wls/docs92/ejb/EJBGen_reference.html#wp1070679
	@RemoteMethod(
	...
	private void connectToQueue()
	{
		...
		try 
	    {
	        ...
	        h.put(javax.naming.Context.PROVIDER_URL,System.getProperty("customURL"));
			...
			javax.naming.InitialContext initialContext = new javax.naming.InitialContext(h);
	...
	private void connectToTopic()
	{
		...
		try 
	    {
			LH.trace(VERSION, PACKAGE_AND_CLASS, METHOD,
				"Establish initial context");
			Hashtable<String,String> h = new Hashtable<String,String>();
			System.out.println("Connecting to custom URL: "+System.getProperty("customURL"));
	        h.put(javax.naming.Context.PROVIDER_URL,System.getProperty("customURL"));
			h.put(javax.naming.Context.INITIAL_CONTEXT_FACTORY, "weblogic.jndi.WLInitialContextFactory");
			h.put(weblogic.jndi.WLContext.ALLOW_EXTERNAL_APP_LOOKUP, "true");
			javax.naming.InitialContext initialContext = new javax.naming.InitialContext(h);
