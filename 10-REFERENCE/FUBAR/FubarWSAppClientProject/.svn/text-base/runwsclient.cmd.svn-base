...
%JAVA_BIN%\java -classpath wsclientimpl.jar;FubarWSAppClient.jar;%WEBLOGIC_LIB%\weblogic.jar;%WEBLOGIC_LIB%\webservices.jar com.weblogic.sample.clientapp.FubarWSAppClient %PROTOCOL_HOST_AND_PORT%  1 100 1 false false 100 
