...
<HTML>
  ...
  <HEAD>
  <TITLE>Global Transaction from Servlet</TITLE>
  </HEAD>
  ...
  <BODY BGCOLOR=#BBCCDD>
    ...
    <CENTER><H1>Global Transaction from Servlet</H1></CENTER>

    <HR WIDTH=100%>

    <CENTER><H2>Transfer Funds</H2></CENTER>

    <FORM NAME=GlobalTransaction METHOD=get ACTION="/transactions-globalweb/GlobalWebServlet">
        ...
        <TD><FONT SIZE=3>
          <SELECT NAME=from_bank SIZE=1>
		  	<% if(fromBank.equals("Local Bank")){
            	out.println("<OPTION SELECTED VALUE=\"Local Bank\">Local Bank</OPTION>");
	            out.println("<OPTION VALUE=\"Foreign Bank\">Foreign Bank</OPTION>");
			}
			else{
            	out.println("<OPTION  VALUE=\"Local Bank\">Local Bank</OPTION>");
	            out.println("<OPTION SELECTED VALUE=\"Foreign Bank\">Foreign Bank</OPTION>");
			}%>	
