...
package samples.transactions.ejb.cmt.simple.servlet;
...
import samples.transactions.ejb.cmt.simple.ejb.GlobalBankService;
import samples.transactions.ejb.cmt.simple.ejb.GlobalBankServiceHome;

/**
 * This servlet is responsible for presenting the pages for the transactions-globalcmt application and using container Managed through an EJB to complete transactions  between the two datasources.
*/

public class GlobalCmtServlet extends HttpServlet {
   ...
   "java:comp/env/ejb/GlobalBankServiceEJBcmt";
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if ( r.detail != null && r.detail.getMessage() != null ) {
                ...
                // Container must have thrown a TransactionRolledbackException
                // which has no message, so get the message from the bean.

                p_request.setAttribute( "message",
                "TRANSFER FAILED: "+m_globalBankService.getMessage( ) );
            }
        }
        catch( Throwable e ) {
            p_request.setAttribute( "message",
...
//------------------------------ private methods -----------------------------//
    ...
    throws ServletException {
        ...
        try {
            ...
            "GlobalCmtServlet.getGlobalBankService(): "+t );
        }
    }
