 ...
 * remote interface.
 * Clients generally take the help of JNDI to lookup the bean's home interface and then use the home interface to obtain reference to the bean's remote interface.
