...
public class SimpleInterestServlet extends HttpServlet
{
    ...
    */
	...
	throws ServletException, IOException
	{
	    ...
	    sess.setAttribute("si_principal",Double.toString(principal));
	    sess.setAttribute("si_time",Double.toString(time));
	    sess.setAttribute("si_rate",Double.toString(rate));
    ...
    */
    ...
    private SimpleInterest getremoteEJB() {
        ...
        try {
          ...
          // String JNDIName = "ejb/SunONE.pkgingB.pkgingBEJB.SimpleInterest";
          String JNDIName = "java:comp/env/ejb/SunONE.pkging.pkgingEJB.SimpleInterest";
