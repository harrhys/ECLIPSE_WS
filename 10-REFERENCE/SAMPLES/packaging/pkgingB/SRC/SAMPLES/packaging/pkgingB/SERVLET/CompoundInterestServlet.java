 ...
 */
package samples.packaging.pkgingB.servlet;
...
public class CompoundInterestServlet extends HttpServlet
{
    ...
    */
	...
	throws ServletException, IOException
	{
	    ...
	    // put these values into session for subsequent use
	    // if session does not exist create one
	    sess = req.getSession(true);
	    sess.setAttribute("ci_principal",Double.toString(principal));
	    sess.setAttribute("ci_time",Double.toString(time));
	    sess.setAttribute("ci_rate",Double.toString(rate));
    ...
    */
    ...
    private CompoundInterest getremoteEJB() {
        ...
        try {
          ...
          // String JNDIName = "ejb/SunONE.pkgingB.pkgingBEJB.CompoundInterest";
          String JNDIName = "java:comp/env/ejb/SunONE.pkging.pkgingEJB.CompoundInterest";
