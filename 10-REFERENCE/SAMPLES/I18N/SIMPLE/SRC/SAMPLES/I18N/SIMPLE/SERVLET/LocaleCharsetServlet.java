...
/**
 * Servlet used to verify the locale-charset table mapping implementation in Sun ONE Application Server
 * @author  Chand Basha
 * @version	1.0
 */
public class LocaleCharsetServlet extends HttpServlet {
    ...
    public String getServletInfo() {
        return "Servlet used to verify the locale-charset table mapping implementation in Sun ONE Application Server";
    }
