...
echo %JAVA_HOME%\bin\java samples.jms.soaptojms.SendSOAPMessageWithJMS TESTTOPIC
call %JAVA_HOME%\bin\java samples.jms.soaptojms.SendSOAPMessageWithJMS TESTTOPIC
